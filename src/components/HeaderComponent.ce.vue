...
const appsDropdown = ref(null)
const appsDropdownButton = ref(null)
const notificationDropdown = ref(null)
const notificationDropdownButton = ref(null)
const userDropdown = ref(null)
const userDropdownButton = ref(null)
const throwLog = (ev) => console.log('Click me!!', { ev })

onMounted(() => {
  console.log('<HeaderComponent>')

  if (appsDropdown.value) {
    console.log('apps dropdown is ready')

    const appsDropdownEvent = new Dropdown(appsDropdown.value, appsDropdownButton.value)
    appsDropdownEvent.init()

    const notificationDropdownEvent = new Dropdown(
      notificationDropdown.value,
      notificationDropdownButton.value
    )
    notificationDropdownEvent.init()

    const userDropdownEvent = new Dropdown(userDropdown.value, userDropdownButton.value)
    userDropdownEvent.init()
  }
})
</script>
  ...
  >
    <div class="flex flex-wrap items-center justify-between">
      ...
      <div class="flex items-center justify-start">
        ...
        <a href="" @click.prevent="throwLog" class="mr-4 flex items-center justify-between">
          <slot></slot>
        </a>
      </div>
      ...
      <div class="flex items-center lg:order-2">
        ...
        <button
          id="apps-dropdown-button"
          ref="appsDropdownButton"
          type="button"
        ...
        <div
          class="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded-xl border bg-white text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
          id="apps-dropdown"
          ref="appsDropdown"
        >
          <div
            class="block bg-gray-700 px-4 py-2 text-center text-base font-medium text-gray-50 dark:bg-gray-600 dark:text-gray-300"
          >
            Apps
          </div>
